import { Activity, Heart, Brain, Bell, Users, Phone, LayoutDashboard, Stethoscope, BookOpen, Settings, Bluetooth } from "lucide-react";
...
const mainItems = [
  ...
  { title: "Doctor Panel", url: "/doctor", icon: Stethoscope },
  { title: "Family View", url: "/family", icon: Users },
];
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-sidebar-foreground/60">Health Monitoring</span>
            </div>
          )}
        </div>
      </SidebarHeader>
